Feature: API behaviors on the cryptocurrency endpont
  ...
  Scenario Outline: Retrieving technical documentation
    ...
    And the technical doc uri should be "<tech_uri>"
  ...
  Examples:
    ...
    | Ethereum | 1027 | https://s2.coinmarketcap.com/static/img/coins/64x64/1027.png | https://github.com/ethereum/wiki/wiki/White-Paper | ETH    | 2015-08-07T00:00:00.000Z | null     | mineable |
